...
class TableCollection{
	...
	public static function parent($tableA, $tableB){
		if(count($tableA->dependencies)==0) return $tableA;
		if(count($tableB->dependencies)==0) return $tableB;
		foreach($tableA->dependencies as $dependency){
			if($dependency == $tableB->name) return $tableB;
		}
		return $tableA;
	}
